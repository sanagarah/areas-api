...
using areas_api.Mapping;
using areas_api.Middlewares;
...
var logger = new LoggerConfiguration()
    .WriteTo.Console()
    .WriteTo.File("Logs/areas-apis-logs.txt", rollingInterval: RollingInterval.Minute)
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("areasApi")
